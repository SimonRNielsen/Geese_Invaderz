...
class LevelTimer:
    ...
    def draw(self):
        ...
        #Drawing time left of the level on top of the screen
...
class EnemyDeath:
    ...
    def draw(self):
        ...
        #Drawing the the amount of killed enemies on the play screen
